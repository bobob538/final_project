...
if (!empty($title) || !empty($author) || !empty($category) || !empty($year)) {
    ...
    if (isset($conn) && $conn instanceof mysqli) {
        ...
        if ($stmt) {
            ...
            echo "<div style='color:red;text-align:center;'>Error preparing statement: " . htmlspecialchars($conn->error) . "</div>";
        }
    } else {
        echo "<div style='color:red;text-align:center;'>Database connection error.</div>";
    }
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <main class="container">
        <section class="search-section">
            ...
            <form action="search - USER.php" method="GET" class="search-form">
        ...
        <?php else: ?>
            <div class="no-results">
                <h2>ببورە، هیچ ئەنجامی پێشنیار ناکرێت</h2>
                <p>تکایە پارامەترەکانی گەڕان بگۆڕە و هەوڵی نوێ بدە.</p>
            </div>
        <?php endif; ?>
    </main>
    ...
    <footer>
        <div class="container">
            <p>© 2023 کتێبخانە. هەموو مافەکان پاراستن.</p>
        </div>
    </footer>
</body>
</html>
